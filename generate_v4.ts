...
const fileContent = fs.readFileSync('./data/structured_1000_cases_v4.txt', 'utf-8');
...
fs.writeFileSync(process.env.HOME + '/Desktop/final_results_v4.txt', output.trim());

console.log('File generated: ~/Desktop/final_results_v4.txt');
