...
function parseCases(fileContent: string): Map<number, string> {
...
function parseResults(fileContent: string): Map<number, string[]> {
...
function auditAndCorrect(caseId: number, input: string, codes: string[]): AuditResult {
    const errors: string[] = [];
    ...
    if (lower.includes('ckd') || (lower.includes('chronic kidney') && lower.includes('disease'))) {
        ...
        if (!hasN18 && correctedCodes.length > 0) {
            ...
            if (lower.includes('stage 1')) stage = '1';
            else if (lower.includes('stage 2')) stage = '2';
            else if (lower.includes('stage 3b')) stage = '32';
            else if (lower.includes('stage 3a')) stage = '31';
            else if (lower.includes('stage 3')) stage = '30';
            else if (lower.includes('stage 4')) stage = '4';
            else if (lower.includes('stage 5')) stage = '5';
