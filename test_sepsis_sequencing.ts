...
const test1 = runRulesEngine('Patient presents with urosepsis and septic shock');
console.log('\nCodes:');
...
const test2 = runRulesEngine(
    'Severe acute respiratory failure due to pneumonia following an open percutaneous transluminal coronary angioplasty (PTCA) procedure performed 3 days ago'
);
console.log('\nCodes:');
...
const test3 = runRulesEngine('Patient has sepsis due to urinary tract infection');
console.log('\nCodes:');
...
const test4 = runRulesEngine('Patient presents with E. coli sepsis, septic shock, and UTI');
console.log('\nCodes:');
