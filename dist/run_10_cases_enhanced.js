...
console.log('ICD-10-CM ENGINE OUTPUT (WITH ENHANCED VALIDATION)');
...
cases.forEach(testCase => {
    ...
    try {
        ...
        const finalResult = (0, validator_enhanced_1.validateFinalOutput)(validated.codes, testCase.input);
        if (finalResult.output === 'NO CODABLE DIAGNOSIS') {
            console.log('OUTPUT: NO CODABLE DIAGNOSIS');
        }
        else if (finalResult.codes.length === 0) {
...
console.log('='.repeat(80));
console.log('All cases processed with enhanced validation rules');
