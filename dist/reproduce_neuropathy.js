...
const diabetesResolver_1 = require("./lib/diabetesResolver");
const testCases = [
...
testCases.forEach((test, index) => {
    const result = (0, diabetesResolver_1.resolveDiabetes)(test.text);
    ...
    let actualCode = result === null || result === void 0 ? void 0 : result.code;
