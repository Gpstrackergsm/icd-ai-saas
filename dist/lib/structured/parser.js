...
function parseInput(text) {
        ...
        switch (key) {
            ...
            case 'cause':
                ...
                if (key === 'cause' && lowerValue.includes('blood loss')) {
                    if (!context.conditions.hematology)
                        context.conditions.hematology = {};
                    if (!context.conditions.hematology.anemia)
                        context.conditions.hematology.anemia = { type: 'iron_deficiency' };
                ...
                if (lowerValue.includes('sepsis')) {
                    if (!context.conditions.infection)
                        context.conditions.infection = { present: true };
                    if (!context.conditions.infection.sepsis)
                        context.conditions.infection.sepsis = { present: true };
                    if (lowerValue.includes('severe'))
                        context.conditions.infection.sepsis.severe = true;
                    if (lowerValue.includes('shock'))
                        context.conditions.infection.sepsis.shock = true;
                    // Organism extraction
                    if (lowerValue.includes('e. coli') || lowerValue.includes('escherichia coli'))
                        context.conditions.infection.organism = 'e_coli';
                    else if (lowerValue.includes('mrsa'))
                        context.conditions.infection.organism = 'mrsa';
                    else if (lowerValue.includes('mssa'))
                    ...
                    else if (lowerValue.includes('streptococcus') || lowerValue.includes('strep'))
                        context.conditions.infection.organism = 'strep';
                    else if (lowerValue.includes('proteus'))
                        context.conditions.infection.organism = 'proteus';
                    else if (lowerValue.includes('enterococcus'))
                        context.conditions.infection.organism = 'enterococcus';
                    else if (lowerValue.includes('candida'))
                        context.conditions.infection.organism = 'candida';
                    else if (lowerValue.includes('bacteroides'))
                ...
                if (lowerValue.includes('pneumonia')) {
                    ...
                    if (lowerValue.includes('mrsa'))
                        context.conditions.respiratory.pneumonia.organism = 'mrsa';
                    else if (lowerValue.includes('mssa'))
                        context.conditions.respiratory.pneumonia.organism = 'mssa';
                    else if (lowerValue.includes('pseudomonas'))
                        context.conditions.respiratory.pneumonia.organism = 'pseudomonas';
                    else if (lowerValue.includes('klebsiella'))
                        context.conditions.respiratory.pneumonia.organism = 'klebsiella';
                    else if (lowerValue.includes('e. coli'))
                        context.conditions.respiratory.pneumonia.organism = 'e_coli';
                    else if (lowerValue.includes('mycoplasma'))
                        context.conditions.respiratory.pneumonia.organism = 'mycoplasma';
                    else if (lowerValue.includes('viral'))
                        context.conditions.respiratory.pneumonia.organism = 'viral';
                }
                // COPD
                if (lowerValue.includes('copd')) {
                    if (!context.conditions.respiratory)
                ...
                if (lowerValue.includes('ckd') || lowerValue.includes('chronic kidney disease')) {
                    if (!context.conditions.ckd)
                        context.conditions.ckd = { stage: undefined, onDialysis: false, aki: false, transplantStatus: false };
                    if (lowerValue.includes('stage 4'))
                        context.conditions.ckd.stage = 4;
                    if (lowerValue.includes('stage 5'))
                        context.conditions.ckd.stage = 5;
                    if (lowerValue.includes('esrd'))
                ...
                if (lowerValue.includes('cirrhosis')) {
                    ...
                    if (lowerValue.includes('alcoholic'))
                        context.conditions.gastro.cirrhosis.type = 'alcoholic';
                }
                ...
                if (lowerValue.includes('preeclampsia')) {
                    if (!context.conditions.obstetric)
                ...
                if (lowerValue.includes('cancer') || lowerValue.includes('carcinoma') || lowerValue.includes('neoplasm')) {
                    if (!context.conditions.neoplasm)
                        context.conditions.neoplasm = { present: true, active: true };
                    ...
                    if (lowerValue.includes('breast'))
                        context.conditions.neoplasm.site = 'breast';
                    if (lowerValue.includes('colon'))
                        context.conditions.neoplasm.site = 'colon';
                    if (lowerValue.includes('prostate'))
                ...
                if (lowerValue.includes('alzheimer')) {
                    if (!context.conditions.neurology)
                        context.conditions.neurology = {};
                ...
                if (lowerValue.includes('hemiplegia')) {
                    ...
                    if (lowerValue.includes('right'))
                        context.conditions.neurology.hemiplegia.side = 'right';
                    if (lowerValue.includes('left'))
                        context.conditions.neurology.hemiplegia.side = 'left';
                }
                // Infection (HIV/TB)
                ...
                if (lowerValue.includes('osteoporosis')) {
                    if (!context.conditions.musculoskeletal)
                        context.conditions.musculoskeletal = {};
                ...
                if (lowerValue.includes('fracture') && lowerValue.includes('pathological')) {
                    ...
                    if (lowerValue.includes('femur'))
                        context.conditions.musculoskeletal.pathologicalFracture.site = 'femur';
                }
                // Mental Health
                if (lowerValue.includes('depressive') || lowerValue.includes('depression')) {
                    if (!context.conditions.mental_health)
                        context.conditions.mental_health = {};
                    context.conditions.mental_health.depression = { severity: 'moderate' }; // Default
                    if (lowerValue.includes('severe'))
                        context.conditions.mental_health.depression.severity = 'severe';
                    if (lowerValue.includes('mild'))
                        context.conditions.mental_health.depression.severity = 'mild';
                    if (lowerValue.includes('psychotic'))
                ...
                if ((lowerValue.includes('pneumonia') || lowerValue.includes('pneumonitis')) && key.toLowerCase() !== 'status') {
                    ...
                    if (!context.conditions.respiratory.pneumonia) {
                        ...
                        if (lowerValue.includes('streptococcus pneumoniae') || lowerValue.includes('strep pneumoniae'))
                            organism = 'strep_pneumoniae';
                        else if (lowerValue.includes('haemophilus') || lowerValue.includes('h. influenzae'))
                        ...
                        // VAP detection
                        if (lowerValue.includes('ventilator'))
                ...
                if (lowerValue.includes('anemia')) {
                    ...
                    if (lowerValue.includes('iron deficiency'))
                        context.conditions.hematology.anemia.type = 'iron_deficiency';
                }
                ...
                if (lowerValue.includes('diabetic') || lowerValue.includes('diabetes')) {
                    ...
                    if (lowerValue.includes('ketoacidosis'))
            ...
            case 'diabetes type':
                if (!context.conditions.diabetes)
                    context.conditions.diabetes = { type: 'type2', complications: [] };
                if (lowerValue === 'type 1')
                    context.conditions.diabetes.type = 'type1';
                else if (lowerValue === 'type 2')
                    context.conditions.diabetes.type = 'type2';
                else if (lowerValue.includes('drug'))
                    context.conditions.diabetes.type = 'drug_induced';
                else if (lowerValue.includes('secondary'))
                    context.conditions.diabetes.type = 'secondary';
                else
                    errors.push(`Invalid diabetes type: ${value}`);
                break;
                ...
                comps.forEach(c => {
                    if (c === 'neuropathy')
                        ...
                        context.conditions.diabetes.complications.push('hypoglycemia');
                    else if (c === 'ketoacidosis')
                        context.conditions.diabetes.complications.push('ketoacidosis');
                    else if (c === 'hyperosmolar')
                        context.conditions.diabetes.complications.push('hyperosmolar');
                    else if (c === 'gangrene')
                        context.conditions.diabetes.complications.push('gangrene');
                    else if (c === 'amputation')
                        context.conditions.diabetes.complications.push('amputation');
                    else if (c === 'unspecified')
                        context.conditions.diabetes.complications.push('unspecified');
                    else if (c)
                        errors.push(`Unknown diabetes complication: ${c}`);
                });
                break;
            case 'insulin use':
                if (!context.conditions.diabetes)
            ...
            case 'ulcer site':
                ...
                if (lowerValue.includes('left') && lowerValue.includes('foot'))
                    context.conditions.diabetes.ulcerSite = 'foot_left';
                else if (lowerValue.includes('right') && lowerValue.includes('foot'))
                    context.conditions.diabetes.ulcerSite = 'foot_right';
                else
            ...
            case 'wound depth':
                if (!context.conditions.diabetes)
                    context.conditions.diabetes = { type: 'type2', complications: [] };
                if (lowerValue.includes('muscle'))
                    context.conditions.diabetes.ulcerSeverity = 'muscle';
                else if (lowerValue.includes('bone'))
                    context.conditions.diabetes.ulcerSeverity = 'bone';
                else if (lowerValue.includes('fat'))
                    context.conditions.diabetes.ulcerSeverity = 'fat'; // Fat layer exposed = fat depth (L97.x12)
            ...
            case 'ckd stage':
                if (!context.conditions.ckd)
                    context.conditions.ckd = { stage: undefined, onDialysis: false, aki: false, transplantStatus: false };
                if (value === '1')
                    context.conditions.ckd.stage = 1;
                else if (value === '2')
                    context.conditions.ckd.stage = 2;
                else if (value === '3')
                    context.conditions.ckd.stage = 3;
                else if (value === '4')
                    context.conditions.ckd.stage = 4;
                else if (value === '5')
                    context.conditions.ckd.stage = 5;
                else if (lowerValue === 'esrd')
                    context.conditions.ckd.stage = 'esrd';
                else
            ...
            case 'chf':
                ...
                if (parseBoolean(value) || value.toLowerCase() !== 'no') {
                    ...
                    // Detect type
                    if (lv.includes('systolic'))
                        type = 'systolic';
                    else if (lv.includes('diastolic'))
                        type = 'diastolic';
                    else if (lv.includes('combined'))
                        type = 'combined';
                    // Detect acuity
                    if (lv.includes('acute on chronic') || lv.includes('acute-on-chronic'))
                        acuity = 'acute_on_chronic';
                    else if (lv.includes('acute'))
                        acuity = 'acute';
                    else if (lv.includes('chronic'))
                        acuity = 'chronic';
            ...
            case 'heart failure type':
                ...
                if (['systolic', 'diastolic', 'combined'].includes(lowerValue))
            ...
            case 'heart failure acuity':
                ...
                if (lowerValue.includes('acute on chronic'))
                    context.conditions.cardiovascular.heartFailure.acuity = 'acute_on_chronic';
                else if (lowerValue === 'acute')
                    context.conditions.cardiovascular.heartFailure.acuity = 'acute';
                else if (lowerValue === 'chronic')
            ...
            case 'pneumonia organism':
                ...
                if (lowerValue.includes('pseudomonas'))
                    context.conditions.respiratory.pneumonia.organism = 'pseudomonas';
                else if (lowerValue.includes('mrsa'))
                    context.conditions.respiratory.pneumonia.organism = 'mrsa';
                else if (lowerValue.includes('mssa'))
            ...
            case 'organism':
                ...
                if (lowerValue.includes('mrsa'))
                    ...
                    context.conditions.infection.organism = 'pseudomonas';
                else if (lowerValue.includes('staphylococcus aureus') || lowerValue.includes('staph aureus'))
                    context.conditions.infection.organism = 'mssa';
                else if (lowerValue.includes('staphylococcus') || lowerValue.includes('staph'))
                    context.conditions.infection.organism = 'staph';
                else if (lowerValue.includes('streptococcus') || lowerValue.includes('strep'))
                    context.conditions.infection.organism = 'strep';
                else if (lowerValue.includes('klebsiella'))
                    context.conditions.infection.organism = 'klebsiella';
            ...
            case 'sepsis':
                if (!context.conditions.infection)
                    context.conditions.infection = { present: true };
                if (!context.conditions.infection.sepsis)
                    context.conditions.infection.sepsis = { present: false };
            ...
            case 'laterality':
                if (!context.conditions.injury)
                    context.conditions.injury = { present: true };
                if (lowerValue.includes('left'))
                    context.conditions.injury.laterality = 'left';
                else if (lowerValue.includes('right'))
                    context.conditions.injury.laterality = 'right';
            ...
            case 'mechanism':
                if (!context.conditions.injury)
                    context.conditions.injury = { present: true };
                if (!context.conditions.injury.externalCause)
                    context.conditions.injury.externalCause = { present: true };
                if (lowerValue.includes('fall'))
                    context.conditions.injury.externalCause.mechanism = 'fall';
                else if (lowerValue.includes('mvc') || lowerValue.includes('motor vehicle'))
                    context.conditions.injury.externalCause.mechanism = 'mvc';
                else if (lowerValue.includes('assault'))
                    context.conditions.injury.externalCause.mechanism = 'assault';
                else if (lowerValue.includes('sport'))
                    context.conditions.injury.externalCause.mechanism = 'sports';
                else
                    context.conditions.injury.externalCause.mechanism = 'other';
                break;
            // Neurology
            ...
            case 'encephalopathy type':
                ...
                if (!context.conditions.neurology.encephalopathy)
                    context.conditions.neurology.encephalopathy = { present: true };
                if (lowerValue.includes('metabolic'))
                    context.conditions.neurology.encephalopathy.type = 'metabolic';
                else if (lowerValue.includes('toxic'))
                    context.conditions.neurology.encephalopathy.type = 'toxic';
                else if (lowerValue.includes('hepatic'))
                    context.conditions.neurology.encephalopathy.type = 'hepatic';
                else if (lowerValue.includes('hypoxic'))
                    context.conditions.neurology.encephalopathy.type = 'hypoxic';
                break;
            case 'seizure':
            ...
            case 'dementia':
                if (!context.conditions.neurology)
                    context.conditions.neurology = {};
                if (parseBoolean(value))
                    context.conditions.neurology.dementia = { type: 'unspecified' };
                break;
            case 'dementia type':
                if (!context.conditions.neurology)
                    context.conditions.neurology = {};
                if (!context.conditions.neurology.dementia)
                    context.conditions.neurology.dementia = { type: 'unspecified' };
                if (lowerValue.includes('alzheimer'))
                    context.conditions.neurology.dementia.type = 'alzheimer';
                else if (lowerValue.includes('vascular'))
                    context.conditions.neurology.dementia.type = 'vascular';
                break;
            case 'parkinson':
            case 'parkinsons':
                if (!context.conditions.neurology)
            ...
            case 'glasgow coma scale':
                ...
                if (!isNaN(gcsValue))
                    context.conditions.neurology.gcs = gcsValue;
                break;
            // Gastroenterology
            case 'liver disease':
                if (!context.conditions.gastro)
            ...
            case 'cirrhosis type':
                if (!context.conditions.gastro)
                    context.conditions.gastro = {};
                if (!context.conditions.gastro.cirrhosis)
                    context.conditions.gastro.cirrhosis = { type: 'unspecified' };
                if (lowerValue.includes('alcoholic'))
                    context.conditions.gastro.cirrhosis.type = 'alcoholic';
                else if (lowerValue.includes('nash'))
                    context.conditions.gastro.cirrhosis.type = 'nash';
                break;
            case 'hepatitis':
                if (!context.conditions.gastro)
                    context.conditions.gastro = {};
                if (parseBoolean(value))
                    context.conditions.gastro.hepatitis = { type: 'unspecified' };
                break;
            case 'hepatitis type':
                if (!context.conditions.gastro)
                    context.conditions.gastro = {};
                if (!context.conditions.gastro.hepatitis)
                    context.conditions.gastro.hepatitis = { type: 'unspecified' };
                if (lowerValue === 'a')
                    context.conditions.gastro.hepatitis.type = 'a';
                else if (lowerValue === 'b')
                    context.conditions.gastro.hepatitis.type = 'b';
                else if (lowerValue === 'c')
                    context.conditions.gastro.hepatitis.type = 'c';
                else if (lowerValue.includes('alcoholic'))
                    context.conditions.gastro.hepatitis.type = 'alcoholic';
                break;
            case 'gi bleeding':
                if (!context.conditions.gastro)
                    context.conditions.gastro = {};
                if (parseBoolean(value))
                    context.conditions.gastro.bleeding = { site: 'unspecified' };
                break;
            case 'bleeding site':
                if (!context.conditions.gastro)
                    context.conditions.gastro = {};
                if (!context.conditions.gastro.bleeding)
                    context.conditions.gastro.bleeding = { site: 'unspecified' };
                if (lowerValue.includes('upper'))
                    context.conditions.gastro.bleeding.site = 'upper';
                else if (lowerValue.includes('lower'))
                    context.conditions.gastro.bleeding.site = 'lower';
                break;
            case 'pancreatitis':
                if (!context.conditions.gastro)
                    context.conditions.gastro = {};
                if (parseBoolean(value))
                    context.conditions.gastro.pancreatitis = { type: 'unspecified' };
                break;
            case 'pancreatitis type':
                if (!context.conditions.gastro)
                    context.conditions.gastro = {};
                if (!context.conditions.gastro.pancreatitis)
                    context.conditions.gastro.pancreatitis = { type: 'unspecified' };
                if (lowerValue.includes('acute'))
                    context.conditions.gastro.pancreatitis.type = 'acute';
                else if (lowerValue.includes('chronic'))
                    context.conditions.gastro.pancreatitis.type = 'chronic';
                break;
            case 'ascites':
                if (!context.conditions.gastro)
                    context.conditions.gastro = {};
            ...
            case 'metastatic site':
                if (!context.conditions.neoplasm)
                    context.conditions.neoplasm = { present: true, metastasis: true };
                if (lowerValue.includes('bone'))
                    context.conditions.neoplasm.metastaticSite = 'bone';
                else if (lowerValue.includes('brain'))
                    context.conditions.neoplasm.metastaticSite = 'brain';
                else if (lowerValue.includes('liver'))
                    context.conditions.neoplasm.metastaticSite = 'liver';
                else if (lowerValue.includes('lung'))
                    context.conditions.neoplasm.metastaticSite = 'lung';
                break;
            case 'chemotherapy':
                if (!context.conditions.neoplasm)
                    context.conditions.neoplasm = { present: true };
            ...
            case 'anemia type':
                ...
                if (!context.conditions.hematology.anemia)
                    context.conditions.hematology.anemia = { type: 'unspecified' };
                if (lowerValue.includes('iron'))
                    context.conditions.hematology.anemia.type = 'iron_deficiency';
                else if (lowerValue.includes('b12'))
                    context.conditions.hematology.anemia.type = 'b12_deficiency';
                else if (lowerValue.includes('chronic disease'))
                    context.conditions.hematology.anemia.type = 'chronic_disease';
                else if (lowerValue.includes('blood loss'))
                    context.conditions.hematology.anemia.type = 'acute_blood_loss';
                break;
            case 'coagulopathy':
                if (!context.conditions.hematology)
                    context.conditions.hematology = {};
            ...
            case 'pregnant':
                if (!context.conditions.obstetric)
                    context.conditions.obstetric = {};
                context.conditions.obstetric.pregnant = parseBoolean(value);
                break;
            case 'trimester':
                if (!context.conditions.obstetric)
                    context.conditions.obstetric = { pregnant: true };
                if (lowerValue.includes('1') || lowerValue.includes('first'))
                    context.conditions.obstetric.trimester = 1;
                else if (lowerValue.includes('2') || lowerValue.includes('second'))
                    context.conditions.obstetric.trimester = 2;
                else if (lowerValue.includes('3') || lowerValue.includes('third'))
                    context.conditions.obstetric.trimester = 3;
                break;
            ...
            case 'weeks':
                ...
                if (!isNaN(weeks))
                    context.conditions.obstetric.gestationalAge = weeks;
                break;
            case 'delivery':
                if (!context.conditions.obstetric)
                    context.conditions.obstetric = { pregnant: true };
            ...
            case 'delivery type':
                if (!context.conditions.obstetric)
                    context.conditions.obstetric = { pregnant: true };
                if (!context.conditions.obstetric.delivery)
                    context.conditions.obstetric.delivery = { occurred: true };
                if (lowerValue.includes('vaginal') || lowerValue.includes('normal'))
            ...
            case 'smoking status':
                if (!context.social)
                    context.social = {};
                if (lowerValue.includes('current'))
                    context.social.smoking = 'current';
                else if (lowerValue.includes('former'))
                    context.social.smoking = 'former';
                else if (lowerValue.includes('never'))
            ...
            case 'pack years':
                ...
                if (!isNaN(packYears))
                    context.social.packYears = packYears;
                break;
            case 'alcohol use':
            case 'alcohol':
                if (!context.social)
                ...
                if (lowerValue.includes('abuse'))
                    context.social.alcoholUse = 'abuse';
                else if (lowerValue.includes('dependence'))
                    context.social.alcoholUse = 'dependence';
                else if (parseBoolean(value))
                    context.social.alcoholUse = 'use';
                break;
            case 'drug use':
                if (!context.social)
                    context.social = {};
            ...
            case 'drug type':
                if (!context.social)
                    context.social = {};
                if (!context.social.drugUse)
                    context.social.drugUse = { present: true };
                if (lowerValue.includes('opioid'))
                    context.social.drugUse.type = 'opioid';
                else if (lowerValue.includes('cocaine'))
                    context.social.drugUse.type = 'cocaine';
                else if (lowerValue.includes('cannabis') || lowerValue.includes('marijuana'))
                    context.social.drugUse.type = 'cannabis';
                break;
            case 'homelessness':
            case 'homeless':
                if (!context.social)
    ...
    if (((_a = context.conditions.infection) === null || _a === void 0 ? void 0 : _a.site) === 'lung' && context.conditions.infection.organism && context.conditions.infection.organism !== 'unspecified') {
        if (!context.conditions.respiratory)
            context.conditions.respiratory = {};
        if (!context.conditions.respiratory.pneumonia)
            context.conditions.respiratory.pneumonia = { type: 'unspecified' };
        ...
        if (!context.conditions.respiratory.pneumonia.organism || context.conditions.respiratory.pneumonia.organism === 'unspecified') {
            ...
            context.conditions.respiratory.pneumonia.organism = context.conditions.infection.organism;
        }
    }
    // POST-PROCESSING: Sync Diabetic Ulcer Data
    if (((_b = context.conditions.wounds) === null || _b === void 0 ? void 0 : _b.type) === 'diabetic' && context.conditions.diabetes) {
        // Sync Location
        if (context.conditions.wounds.location) {
            const loc = context.conditions.wounds.location;
            if (loc === 'foot_right')
                context.conditions.diabetes.ulcerSite = 'foot_right';
            else if (loc === 'foot_left')
                context.conditions.diabetes.ulcerSite = 'foot_left';
            else if (loc === 'heel')
                context.conditions.diabetes.ulcerSite = 'foot_right'; // Default/Approximation, ideally check laterality
            else
                context.conditions.diabetes.ulcerSite = 'other';
            // Refine heel mapping if laterality is known
            if (loc === 'heel' && context.conditions.wounds.laterality === 'left')
                context.conditions.diabetes.ulcerSite = 'foot_left';
        }
        // Sync Depth/Severity
