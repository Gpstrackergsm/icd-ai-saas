    ...
    lines.forEach(line => {
        ...
        switch (key) {
            ...
            case 'ckd stage':
                ...
                if (!context.conditions.renal)
                    context.conditions.renal = {};
                if (!context.conditions.renal.ckd)
                    context.conditions.renal.ckd = { stage: 'unspecified' };
                ...
                if (stageVal !== 'unspecified') {
                    context.conditions.ckd.stage = stageVal;
                    context.conditions.renal.ckd.stage = stageVal;
                }
                break;
            case 'dialysis':
    ...
    if (((_b = context.conditions.wounds) === null || _b === void 0 ? void 0 : _b.type) === 'diabetic' && context.conditions.diabetes) {
        ...
        if (context.conditions.wounds.location) {
            ...
            if (loc === 'foot_right')
                ...
                context.conditions.diabetes.ulcerSite = 'right_foot'; // Default/Approximation
            else
                context.conditions.diabetes.ulcerSite = 'other';
