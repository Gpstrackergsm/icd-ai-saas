...
const { context, errors } = (0, parser_1.parseInput)(complexCase);
if (errors.length > 0) {
    console.log('\n❌ Parse Errors:');
...
console.log('='.repeat(80) + '\n');
// Analyze for issues
const codeList = allCodes.map(c => (c === null || c === void 0 ? void 0 : c.code) || '');
...
console.log('\n4. PRIMARY DIAGNOSIS:');
console.log(`   Current Primary: ${(_a = result.primary) === null || _a === void 0 ? void 0 : _a.code} - ${(_b = result.primary) === null || _b === void 0 ? void 0 : _b.label}`);
