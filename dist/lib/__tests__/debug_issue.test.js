...
describe('Debug: Complex Respiratory Scenario with Sepsis', () => {
    test('Post-procedural sepsis with respiratory failure and pneumonia', () => {
        ...
        const result = (0, rulesEngine_js_1.runRulesEngine)(text);
        ...
        console.log('\n📋 Actual Codes:', codes);
        assert_1.default.ok(codes.includes('T81.44XA'), 'Should include T81.44XA (Post-procedural sepsis)');
        assert_1.default.ok(codes.includes('A41.9'), 'Should include A41.9 (Sepsis, unspecified)');
        assert_1.default.ok(codes.includes('J95.821'), 'Should include J95.821 (Post-procedural respiratory failure)');
        assert_1.default.ok(codes.includes('J18.9'), 'Should include J18.9 (Pneumonia)');
        ...
        assert_1.default.ok(t81Index < j95Index, 'T81.44XA should be sequenced before J95.821');
