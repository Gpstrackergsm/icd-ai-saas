...
const test4Result = (0, engine_1.runStructuredRules)(test4.context);
...
const test5Result = (0, engine_1.runStructuredRules)(test5.context);
...
CKD Stage: 4
`;
const test6 = (0, parser_1.parseInput)(test6Input);
const test6Validation = (0, validator_1.validateContext)(test6.context);
const test6Result = (0, engine_1.runStructuredRules)(test6.context);
const hasE11621 = ((_a = test6Result.primary) === null || _a === void 0 ? void 0 : _a.code) === 'E11.621' || test6Result.secondary.some(c => c.code === 'E11.621');
...
console.log('Primary:', (_b = test6Result.primary) === null || _b === void 0 ? void 0 : _b.code);
...
Ulcer Depth: Muscle exposed
`;
const test7 = (0, parser_1.parseInput)(test7Input);
const test7Validation = (0, validator_1.validateContext)(test7.context);
const test7Result = (0, engine_1.runStructuredRules)(test7.context);
