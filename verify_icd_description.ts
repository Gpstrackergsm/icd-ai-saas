import { initIcdData, getCode } from './lib/icd-core/dataSource';

async function verify() {
    await initIcdData();
    const code = getCode('E11.42');
    ...
    const code40 = getCode('E11.40');
    console.log('Code 40:', code40?.longDescription);
    if (code40?.longDescription.includes('AHA:')) {
